...
void (*webui_dcc_telnet_pass) (int) = 0;
...
void add_hook(int hook_num, Function func)
{
  if (hook_num < REAL_HOOKS) {
    ...
    case HOOK_DCC_TELNET_GOT_IDENT:
      ...
      break;
    case HOOK_DCC_TELNET_PASS:
      webui_dcc_telnet_pass = (void (*)(int)) func;
      break;
...
void del_hook(int hook_num, Function func)
{
  if (hook_num < REAL_HOOKS) {
    ...
    case HOOK_DCC_TELNET_GOT_IDENT:
      ...
      break;
    case HOOK_DCC_TELNET_PASS:
      if (webui_dcc_telnet_pass == (void (*)(int)) func)
        webui_dcc_telnet_pass = (void (*)(int)) null_func;
      break;
    case HOOK_WEBUI_FRAME:
